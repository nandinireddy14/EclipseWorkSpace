...
public class BiFunctionAndThenExample2 {
	...
	public static void main(String[] args) {
		BiFunction<String, Integer, Integer> bifunction = getSalaryByAgeAndDesign();
	...
	private static BiFunction<String, Integer, Integer> getSalaryByAgeAndDesign() {
		return (designation, age) -> {
